// Demo of linked list delete operations and other functions
// T17A, Joanna
...
void free_list(struct list *list) {
    // General idea: Loop through list freeing nodes as we go
...
int identical(struct list *first_list, struct list *second_list) {
    ...
    // All data matches
    // Check if we've actually looped to the end of both lists
    // (i.e. the list lengths match)
